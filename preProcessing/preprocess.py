...
if __name__ == "__main__":
    ...
    parser.add_argument('--lower_target', type=list, default=[0, 44, 70], help='lower bound of skin')
    parser.add_argument('--upper_target', type=list, default=[30, 255, 255], help='upper bound of skin')
